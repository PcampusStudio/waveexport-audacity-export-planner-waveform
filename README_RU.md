...
Планировщик настроек экспорта и контрольных прослушиваний аудиопроектов.
...
- **Export format worksheets** — запланированный модуль; реализации нет.
- **Loudness target notes** — запланированный модуль; реализации нет.
- **Listening review checklist** — запланированный модуль; реализации нет.
...
3. Опишите один контрольный сценарий для **Export format worksheets**.
...
Зафиксируйте входные данные и ожидаемый результат для модуля 1. Запишите версию Audacity, условия сценария и известные ограничения. Выполнение этих действий вручную не подтверждает наличие автоматизированного инструмента.

### Loudness target notes

Зафиксируйте входные данные и ожидаемый результат для модуля 2. Запишите версию Audacity, условия сценария и известные ограничения. Выполнение этих действий вручную не подтверждает наличие автоматизированного инструмента.

### Listening review checklist

Зафиксируйте входные данные и ожидаемый результат для модуля 3. Запишите версию Audacity, условия сценария и известные ограничения. Выполнение этих действий вручную не подтверждает наличие автоматизированного инструмента.

### Кратко

| Поле | Значение |
|---|---|
| Продукт или область | Audacity |
| Категория | Инструменты для программ |
| Входные данные | Ручные записи или разрешенный пользователем локальный экспорт |
| Планируемый результат | Export format worksheets |
